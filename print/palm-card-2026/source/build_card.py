...
<svg viewBox="0 0 100 100" class="icn">
  ...
  <text x="50" y="62" class="ic-t">Election</text>
  <text x="50" y="77" class="ic-t">Day</text>
</svg>"""
...
<svg viewBox="0 0 100 100" class="icn">
  ...
  <text x="50" y="70" class="ic-t" style="font-size:12.4px">Ballot-By-</text>
  <text x="50" y="84" class="ic-t" style="font-size:12.4px">Mail</text>
</svg>"""
...
<svg viewBox="0 0 100 100" class="icn">
  ...
  <!-- calendar head + body -->
  <rect x="17" y="24" width="66" height="16" fill="#BE0F34"/>
  <rect x="17" y="40" width="66" height="44" fill="#fff"/>
  <text x="50" y="58" class="ic-t">Early</text>
  <text x="50" y="74" class="ic-t">Voting</text>
</svg>"""
...
<div class="inner side1">
  <div class="s1top">
    ...
    <ol class="plan">
      <li>Check your registration.</li>
      <li>Decide how you will vote.</li>
      <li>Find your polling place.</li>
      <li>Review your ballot.</li>
      <li>Learn about the candidates and issues.</li>
      <li>Follow through. &nbsp;Cast your vote.</li>
    </ol>
  </div>
  <div class="s1foot">
    <div class="vic">
      <div class="vic-h">Your Voter Information Center</div>
      <div class="qr">{QR_SVG}</div>
      <div class="vic-h">RI Secretary of State</div>
    </div>
    <img class="nclogo" src="{LOGO_NC}" alt="League of Women Voters of Newport County">
  </div>
  <div class="fund">This card is funded by the League of Women Voters RI Education Fund</div>
</div>"""
...
<div class="inner side2">
  <h1>3 Ways to Vote in RI in 2026</h1>
  <div class="icons">
    <div class="icw">{icon_election_day()}</div>
    <div class="icw">{icon_mail()}</div>
    <div class="icw">{icon_early()}</div>
  </div>

  <h2>General Election &ndash; November 3, 2026</h2>
  <ul class="dates">
    <li><b>October&nbsp;4</b><span>Voter Registration Deadline</span></li>
    <li><b>October&nbsp;13</b><span>Mail Ballot Application Deadline</span></li>
    <li><b>October&nbsp;14&nbsp;&ndash;&nbsp;Nov.&nbsp;2</b><span>Early Voting at Town Halls</span></li>
  </ul>

  <h2 class="id-h">Bring a Valid Photo ID</h2>
  <p class="idnote">IDs must be valid and not have expired more than six&nbsp;(6)&nbsp;months prior
     to voting, but do not need your current address.</p>
  <ul class="ids">
    <li>RI Driver&rsquo;s License or permit, or U.S. Passport</li>
    <li>U.S. Military ID or government-issued medical card</li>
    <li>ID issued by a U.S. educational institution</li>
    <li>United States or Rhode Island ID card</li>
  </ul>
...
.side1 h1{font-size:2.62em;line-height:1.02;margin-bottom:.34em}
...
.plan{list-style:none;counter-reset:step;font-family:'Montserrat',sans-serif;
      font-weight:700;font-size:1.29em;line-height:1.72;margin-left:.30em}
...
.ic-t{font-family:'Montserrat',sans-serif;font-weight:700;font-size:13.2px;
      fill:#0C0064;text-anchor:middle}

.side2 h2{font-family:'Montserrat',sans-serif;font-weight:700;font-size:1.46em;
          line-height:1.2;color:%(navy)s;margin-bottom:.16em}
.id-h{margin-top:.40em}

.dates{list-style:none;font-size:1.05em;line-height:1.34;margin-left:.45em}
...
.idnote{font-size:.92em;line-height:1.30;margin:0 0 .20em}
.ids{list-style:none;font-size:.97em;line-height:1.30;margin-left:.45em}
...
def build(trim_w, trim_h, press, label):
    ...
    css = CSS % dict(
        ...
        qr=trim_w * 0.118, nclogo=trim_w * 0.330, photow=trim_w * 0.268, mark=trim_w * 0.105,
        icon=trim_w * 0.148, icgap=trim_w * 0.083,
        cmw=0.0055, cml=MARK_MARGIN - 0.06,
    )
    ...
    print(f"{path.name}  page {pw:.3f}x{ph:.3f}in  trim {trim_w}x{trim_h}in  "
          f"bleed {bleed}in  {len(html)/1024:.0f}KB")
    return path


if __name__ == "__main__":
    for w, h, tag in [(6.0, 4.0, "6x4"), (8.5, 5.5, "8.5x5.5")]:
        build(w, h, press=True, label=f"{tag}-press")
        build(w, h, press=False, label=f"{tag}-proof")
